    ...
    <>
      {isLoading ? (
        <div className='justify-center items-center flex bg-black h-full'>
          <img src={windows1} alt="loading" className='w-4/5 mt-9 bg-black '/>
        ...
        <>
          ...
          {currentPage === "Home" && (
            <div className="window-body">
              ...
              <div className="window flex top-10 mb-9" role="tabpanel">
                <div className="window w-11/12 h-auto">
                ...
                <div className='right-2 fixed w-32'>
              ...
              <div id='info' className='inline-block bottom-0 mt-3 w-full'>
                      <div className="title-bar justify-around ">
                          <div className='title-bar-text text-xl text-center flex'><img src={anbg}  className='w-28 -ml-20 -mr-7 -mb-11 -mt-12'></img>Ebrahim Khosravani</div><div className="title-bar-text text-xl mb-5 mt-5 text-center">Email<br></br> <address ><a href='mailto:ebrahimkhosravani3@gmail.com'>ebrahimkhosravani3@gmail.com</a></address></div><div className='title-bar-text text-xl text-center'>location<br></br> Tehran, Iran </div>
          ...
          {currentPage === "Contact" && (
            ...
            <div id='info' className='window inline-block bottom-0 mt-1 h-full w-full'>
                    <div className="title-bar justify-around ">
                        <div className='title-bar-text text-xl text-center flex'><img src={anbg}  className='w-28 -ml-20 -mr-7 -mb-11 -mt-12'></img>Ebrahim Khosravani</div><div className="title-bar-text text-xl mb-5 mt-5 text-center">Email<br></br> <address ><a href='mailto:ebrahimkhosravani3@gmail.com'>ebrahimkhosravani3@gmail.com</a></address></div><div className='title-bar-text text-xl text-center'>location<br></br> Tehran, Iran </div>
